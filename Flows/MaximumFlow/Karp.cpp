 ...
 * since we have also to use the reversed of directed edges when 
 * we are looking for augmenting paths.
 * 
 ...
 * edge will actually not be stored, but it is easy to extend 
 * the implementation - by using an additional matrix - to also 
