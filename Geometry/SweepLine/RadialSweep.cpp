...
/* Determine how many points it can detect while standing in a location
   and an obstacle
   INPUT : N, R. N*N Space, R rocks (obstacles)
   X, Y. where person is standing
   then p, and then p coordinates describing the obstacle (There are r of them).
*/
